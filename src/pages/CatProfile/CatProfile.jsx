            ...
            <section id="catProfile">
                <div className="profilehead">
                    <div className="profileLeft">
                        ...
                        <img src="./images/profile1.png" alt="貓咪頭貼" className="profilePhotoBig" />

                        <img src="./images/profile2.svg" alt="貓咪頭貼" className="profilePhotoSmall" />
                    </div>
                ...
                <div className="profileMain">
                    <div className="profileBox">
                        ...
                        <div className="profileDetail">豆漿是一隻在廢棄空地被發現的小橘貓，當時牠孤零零地躲在一個紙箱裡，身上還有一點小擦傷。我們救援人員靠近時，牠沒有逃跑，只用那雙圓圓的眼睛靜靜望著大家， 彷彿一直在等待著我們來救牠。</div>
                    </div>
                    <div className="profileBox">
                        <CatNameTagAuto name="貓咪個性" catColor="#CAB271" />
                        <div className="profileDetail">豆漿個性比較溫和，第一次見到牠雖然眼神有點害怕，但只要給牠幾天的時間適應，開始會跟人撒嬌，只要多花時間陪牠，相信牠會是一隻非常黏人的小可愛。</div>
                    </div>
                    <div className="profileBox">
